"""Evaluate a QLoRA adapter on a 4-bit base model on round 15 of Korean Bar Exam.

Loads the multimodal base in 4-bit, attaches the LoRA adapter, runs greedy
inference on text-only inputs.
"""
