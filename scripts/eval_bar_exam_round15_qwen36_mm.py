"""Evaluate Qwen3.6 QLoRA on round 15 — multimodal-aware (text-only forward).

Loads Qwen3_5ForConditionalGeneration in 4-bit, attaches LoRA adapter that
was trained on the multimodal model, runs text-only inference.
"""
...
def main() -> None:
    ...
    print(f"loading 4-bit base from {args.base_model} ...", flush=True)
